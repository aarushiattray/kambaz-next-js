export default function SimpleArrays() {
    ...
    let htmlArray1 = [<li key="milk">Buy milk</li>, <li key="pets">Feed the pets</li>]; // added the key parts to get rid of the build error (common reatc error accoriding to Google)
