export default function Positions() {
    return (
        <div>
            ...
            {/* add spacing so Fixed section doesn’t overlap */}
            <div style={{ marginTop: "200px" }} id="wd-css-position-fixed">
                <h2>Fixed position</h2>
                Checkout the blue square that says &quot;Fixed position&quot; stuck all the way
                on the right and half way down the page. It doesn&apos;t scroll with the rest
