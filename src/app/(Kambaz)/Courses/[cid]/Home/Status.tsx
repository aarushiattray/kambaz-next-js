...
import { FaCheckCircle, FaHome, FaChartBar, FaBell } from "react-icons/fa";
...
export default function CourseStatus() {
  return (
    <div id="wd-course-status" style={{ width: "350px" }}>
      ...
      <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
        <PiMegaphoneSimpleFill className="me-2 fs-5" /> New Announcement
      </Button>
      <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
        <MdOutlineQueryStats className="me-2 fs-5" /> New Analytics
      </Button>
      <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
